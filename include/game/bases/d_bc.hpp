...
public:
    ...
    void *mCollidedBelow; // dBg_ctr_c *
    void *mCollidedAbove; // dBg_ctr_c *
    void *mCollidedAdj; // dBg_ctr_c *
    void *mCollidedAdjForDirection[2]; // dBg_ctr_c * [2]
    dBc_c *mPrevTrigBelowSensor;
    dBc_c *mPrevTrigAboveSensor;
    dBc_c *mPrevTrigAdjSensor;
    dBc_c *mPrevTrigAdjSensorForDirection[2];
    void *mLinkW[2]; ///< actually dBg_ctr_c * [2], saves field 'mCollidedAdjForDirection'
    u32 mFlags; // SensorFlags
    u32 mPrevFlags;
    ...
    /// @unofficial
    void set(dActor_c *, dBcSensor_c *, dBcSensor_c *, dBcSensor_c *);
